...
class PlatformFFI {
  ...
  XconnectImpl get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    final dylib = isAndroid
        ? DynamicLibrary.open('libxconnect.so')
        : isLinux
            ? DynamicLibrary.open('libxconnect.so')
            : isWindows
                ? DynamicLibrary.open('libxconnect.dll')
                :
                ...
                //
                // isMacOS? DynamicLibrary.open("liblibxconnect.dylib") :
  ...
  void _startListenEvent(XconnectImpl rustdeskImpl) {
    final appType =
